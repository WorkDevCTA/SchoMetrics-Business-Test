...
import CompanyLoginForm from "./CompanyLoginForm"; // Importa el nuevo componente cliente
...
export default function LoginPage() {
    return (
        <div className="min-h-screen bg-gradient-to-tr from-emerald-200 via-emerald-50 to-emerald-200 py-10">
            <motion.div
