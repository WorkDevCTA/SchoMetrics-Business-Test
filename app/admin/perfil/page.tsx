...
export default function AdminProfilePage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const updatedProfile: AdminUserProfileData = await response.json();
                            ...
                            <div className="flex flex-col items-center">
                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        />
                                        <AvatarFallback className="bg-lime-500 text-3xl uppercase text-white font-bold">
                                ...
                                <CardTitle className="mt-4 text-center text-xl uppercase text-lime-500">
                                    {profile.name}
                                </CardTitle>
                            ...
                            <CardHeader>
                                <div className="flex flex-col items-center justify-between gap-2 pb-2">
                                    ...
                                    <CardDescription className="text-center text-red-500 flex gap-2 justify-center items-center font-semibold">
                                        ...
                                        Por favor, manten siempre completa toda la información de tu Perfil para publicar Materiales Reciclables.
                                    </CardDescription>
                                    ...
                                    {isEditing ? (
                                        <>
                                            {/* <div className="grid gap-2">
                                                <Label htmlFor="name" className="text-sm font-medium">
                                                    Nombre completo (No Modificable)
                                                </Label>
                                                <Input
                                                    id="name"
                                                    name="name"
                                            ...
                                            {/* {profile.userType === "SCHOOL" ? (
                                                <div className="grid gap-2">
                                                    ...
                                                    <Input
                                                        id="cct"
                                                        name="cct"
                                                        value={formData.cct.toUpperCase()}
                                                        onChange={handleChange}
                                                        disabled={isSubmitting}
                                                        required
                                                        className="uppercase"
                                                        placeholder="Clave de Centro de Trabajo (CCT)"
                                                    />
                                                </div>
                                            ) : (
                                                <div className="grid gap-2">
                                                    <Label htmlFor="rfc" className="text-sm font-medium">
                                                        Clave de Registro Federal (RFC)
                                                    </Label>
                                                    <Input
                                                        id="rfc"
                                                        name="rfc"
                                                        ...
                                                        required
                                                        className="uppercase"
                                                        placeholder="Clave de Registro Federal (RFC)"
                                                    />
                                                </div>
                                            )} */}
                                            <div className="grid gap-2">
                                        ...
                                        <>
                                            <div className="space-y-1">
                                                ...
                                                <p className="uppercase text-lime-500 font-semibold">{profile.name}</p>
                                            </div>
...

                                            {
                                                profile.userType === "SCHOOL" ? (
                                                    <div className="flex flex-col gap-2">
                                                        ...
                                                        <div className="space-y-1">
                                                            <h3 className="font-medium">Registro Federal de Contribuyentes (RFC)</h3>
                                                            <p className="text-muted-foreground">
                                                                {profile.profile?.rfc}
                                                            </p>
                                                        </div>
