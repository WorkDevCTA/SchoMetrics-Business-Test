...
export default function SchoolLoginForm() {
  ...
  const callbackUrl = searchParams.get("callbackUrl") || `/escuelas/materiales-publicados/`;

  console.log("Sesión Activa", session?.id);
  ...
  return (
    <Card className="w-full max-w-md border border-lime-100 shadow-lg shadow-lime-100">
