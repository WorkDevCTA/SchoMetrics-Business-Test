...
import { Leaf, User, FileText, Plus, LogOut, Clock, UserCircle, Box, CheckCircle } from "lucide-react"
        ...
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="flex flex-col justify-center items-center gap-2 sm:flex-row sm:items-center sm:gap-4">
              <Button asChild className="bg-lime-600 text-white hover:bg-lime-500" title="Mis Materiales Publicados">
                <Link href="/escuelas/materiales-publicados">
                  <Box className="h-4 w-4 animate-spin" />
                  Materiales
                </Link>
              </Button>
            </div>
