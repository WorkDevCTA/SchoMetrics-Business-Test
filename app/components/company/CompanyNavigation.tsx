...
import { User, LogOut, UserCircle, BadgeDollarSignIcon } from "lucide-react"
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex h-20 items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <Button className="bg-emerald-600 text-white hover:bg-emerald-500" title="Apartar Materiales Reciclables Disponibles">
                            <Link href="/empresas/materiales-disponibles" className="flex items-center justify-center">
                                <BadgeDollarSignIcon className="mr-2 h-6 w-6 animate-heartbeat" />
                                Apartar
                            </Link>
                        </Button>
                        {isLoading ? (
